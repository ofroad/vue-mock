                                  ...
                                  if (0 == i.children.length && e) {
                                    for (var t = n.getObjAllKeys(e), a = 0; a < t.length; a++) {
                                      ...
                                      if (n.isArray(s)) {
                                        ...
                                        v = o.getFoldedLine(s, r.default.render(c.default, { key: t[a], keyType: u, value: f, valueType: 'array' }, !0));
                                      } else if (n.isObject(s)) {
                                        var p = n.getObjName(s);
                                        v = o.getFoldedLine(s, r.default.render(c.default, { key: n.htmlEncode(t[a]), keyType: u, value: p, valueType: 'object' }, !0));
                                      } else {
                                    ...
                                    if (n.isObject(e)) {
                                      var g,
                                        h = e.__proto__;
                                      (g = n.isObject(h) ? o.getFoldedLine(h, r.default.render(c.default, { key: '__proto__', keyType: 'private', value: n.getObjName(h), valueType: 'object' }, !0)) : r.default.render(c.default, { key: '__proto__', keyType: 'private', value: 'null', valueType: 'null' })), i.insertAdjacentElement('beforeend', g);
                                    }
                                  }
                                }),
                                !1
                ...
                x = (function() {
                  function e(t) {
                    if (
                      ...
                      var o = this;
                      if (((this.version = n.default.version), (this.$dom = null), (this.isInited = !1), (this.option = { defaultPlugins: ['system', 'network', 'element', 'storage'] }), (this.activedTab = ''), (this.tabList = []), (this.pluginList = {}), (this.switchPos = { x: 10, y: 10, startX: 0, startY: 0, endX: 0, endY: 0 }), (this.tool = r), (this.$ = i.default), r.isObject(t))) for (var a in t) this.option[a] = t[a];
                    ...
                    (o = [
                      {
                        ...
                        value: function() {
                          ...
                          var e = this.option.defaultPlugins,
                            t = { system: { proto: b.default, name: 'System' }, network: { proto: g.default, name: 'Network' }, element: { proto: h.default, name: 'Element' }, storage: { proto: m.default, name: 'Storage' } };
                          if (e && r.isArray(e))
                            for (var o = 0; o < e.length; o++) {
                              var n = t[e[o]];
            ...
            typeof (n = function(o, n, r, i, a, l) {
              ...
              var p = (function(e) {
                function t() {
                  ...
                  for (var n = arguments.length, i = new Array(n), a = 0; a < n; a++) i[a] = arguments[a];
                  return ((o = u(this, (e = v(t)).call.apply(e, [this].concat(i)))).$tabbox = l.default.render(r.default, {})), (o.currentType = ''), (o.typeNameMap = { cookies: 'Cookies', localstorage: 'LocalStorage', sessionstorage: 'SessionStorage' }), o;
                }
                var o, c, s;
                return (
                  (function(e, t) {
                        ...
                        if (document.cookie && navigator.cookieEnabled) {
                          for (var e = window.location.hostname, t = this.getCookieList(), o = 0; o < t.length; o++) {
                            ...
                            (document.cookie = ''.concat(n, '=;expires=Thu, 01 Jan 1970 00:00:00 GMT')),
                              ...
                              (document.cookie = ''.concat(n, '=;expires=Thu, 01 Jan 1970 00:00:00 GMT;path=/;domain=.').concat(
                                e
                                  .split('.')
                                  .slice(-2)
                                  .join('.')
