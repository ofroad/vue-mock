<template>
  <div class="demo-list">
    <h4 @click="switchPicker('isVisible1')">基本用法</h4>
    <nut-picker :is-visible="isVisible1" :default-value-data="defaultValueData1" :list-data="listData1" @close="switchPicker('isVisible1')" @confirm="setYearValue"> </nut-picker>
  </div>
</template>
